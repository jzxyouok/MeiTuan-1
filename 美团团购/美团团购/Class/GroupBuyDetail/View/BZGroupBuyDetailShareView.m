...
#define Duration 0.3
#define MaxCols 4
@interface BZGroupBuyDetailShareView ()<UMSocialUIDelegate>

@property (strong, nonatomic) UIButton *coverBtn;
@end


@implementation BZGroupBuyDetailShareView
...
- (BZGroupBuyDetailShareBtn *)addShareBtnWithTitle:(NSString *)title imageName:(NSString *)imageName andShareObject:(UMSocialSnsType)socialSnsType;
{
    BZGroupBuyDetailShareBtn *btn = [[BZGroupBuyDetailShareBtn alloc]init];
...
- (void)clickShareBtn:(BZGroupBuyDetailShareBtn *)shareBtn
{
...
{
    CGFloat Margin = 10;
    CGFloat btnW = (BZScreenW - Margin * (MaxCols + 1)) / MaxCols;
    CGFloat btnH = btnW;
    CGFloat btnX = 0;
    CGFloat btnY = 0;
